    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://withgogo.sangsangbiz.com/se2/sample/photo_uploader/file_uploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://withgogo.sangsangbiz.com/se2/sample/photo_uploader/file_uploader.php',	//샘플 URL입니다.
